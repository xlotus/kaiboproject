...
public class VideoGridAdapter extends ListBindingAdapter<ModelLive.Item, ItemVideoGridBinding> {
    ...
    @Override
    public ItemVideoGridBinding createBinding(ViewGroup parent) {
        Logger.d(TAG, "createBinding");
        return ItemVideoGridBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    }

    @Override
    public void onBindViewHolder(ModelLive.Item item, ItemVideoGridBinding binding, int position) {
...
//        binding.tvAnchorName.setText(item.getName());
    ...
    @Override
    public void onItemFocusChanged(ItemVideoGridBinding binding, boolean hasFocus) {
    ...
    private void setStyle(ModelLive.Item data, ItemVideoGridBinding binding, boolean hasFocus) {
